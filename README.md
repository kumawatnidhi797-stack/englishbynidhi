...
<div class="container">
  ...
  <div class="panel">
    <p><b>Definition:</b> Noun is a word that names a person, place, thing, or idea.</p>
    <p><b>Types of Nouns:</b></p>
    <ul>
      <li>Proper Noun (Specific names): Ram, Delhi</li>
      <li>Common Noun (General names): boy, city</li>
      <li>Abstract Noun (Ideas/feelings): happiness, strength</li>
      <li>Concrete Noun (Physical things): book, apple</li>
      <li>Collective Noun (Group names): team, family</li>
    </ul>
    
    <p class="part-title">Examples (Hindi - English):</p>
    <ul class="examples">
      ...
      <li><span class="example-hindi">टीम</span> - team</li>
  ...
  <div class="panel">
    <p><b>Definition:</b> Pronouns replace nouns in a sentence to avoid repetition.</p>
    <p><b>Types:</b></p>
    <ul>
      <li>Personal: I, you, he, she, it, we, they</li>
      <li>Possessive: mine, yours, his, hers</li>
      <li>Reflexive: myself, yourself</li>
      <li>Demonstrative: this, that, these, those</li>
      <li>Interrogative: who, which</li>
    </ul>
    <p class="part-title">Examples (Hindi - English):</p>
    <ul class="examples">
  ...
  <div class="panel">
    <p><b>Definition:</b> Articles define a noun as specific or unspecific.</p>
    <p><b>Types:</b></p>
    <ul>
      <li>Definite Article: <b>the</b> (specific)</li>
      <li>Indefinite Article: <b>a</b>, <b>an</b> (non-specific)</li>
    </ul>
    <p><b>Rules:</b> Use 'an' before vowel sounds, else 'a'.</p>
    <p class="part-title">Examples (Hindi - English):</p>
    <ul class="examples">
  ...
  <div class="panel">
    <p><b>Definition:</b> Gender shows whether a noun/pronoun is male, female, or neutral.</p>
    <p><b>Types:</b></p>
    <ul>
      <li>Masculine: boy, king</li>
      <li>Feminine: girl, queen</li>
      <li>Neuter: chair, table</li>
      <li>Common Gender: teacher, doctor (used for both male & female)</li>
    </ul>
    <p class="part-title">Examples (Hindi - English):</p>
    <ul class="examples">
  ...
  <div class="panel">
    <p><b>Definition:</b> Prepositions show relationship in time, place, direction etc.</p>
    <p><b>Types & Examples:</b></p>
    <ul>
      <li>Place: in, on, under, above</li>
      <li>Time: at, on, in</li>
      <li>Direction: to, towards, into</li>
      <li>Others: of, with, by</li>
    </ul>
    <p class="part-title">Examples (Hindi - English):</p>
    <ul class="examples">
  ...
  <div class="panel">
    <p><b>Definition:</b> Conjunctions join words, phrases, or sentences.</p>
    <p><b>Types:</b></p>
    <ul>
      <li>Coordinating: and, but, or, so</li>
      <li>Subordinating: because, although, if</li>
      <li>Correlative: either...or, neither...nor</li>
    </ul>
    <p class="part-title">Examples (Hindi - English):</p>
    <ul class="examples">
      ...
      <li><span class="example-hindi">क्या तुम चाय या कॉफ़ी लोगे?</span> - Will you have tea or coffee?</li>
  ...
  <div class="panel">
    <p><b>Definition:</b> Adjectives describe or modify nouns.</p>
    <p><b>Types:</b></p>
    <ul>
      <li>Descriptive: beautiful, tall</li>
      <li>Quantitative: some, many</li>
      <li>Demonstrative: this, those</li>
      <li>Possessive: my, her</li>
      <li>Interrogative: which, what</li>
    </ul>
    <p class="part-title">Examples (Hindi - English):</p>
    <ul class="examples">
  ...
  <div class="panel">
    <p><b>Definition:</b> Adverbs modify verbs, adjectives or other adverbs.</p>
    <p><b>Types:</b></p>
    <ul>
      <li>Manner: quickly, slowly</li>
      <li>Place: here, there</li>
      <li>Time: now, yesterday</li>
      <li>Frequency: always, never</li>
      <li>Degree: very, too</li>
    </ul>
    <p class="part-title">Examples (Hindi - English):</p>
    <ul class="examples">
  ...
  <div class="panel">
    <p><b>Definition:</b> Tense shows time of an action or event.</p>
    <p><b>Types:</b></p>
    <ul>
      <li>Present (I eat)</li>
      <li>Past (I ate)</li>
      <li>Future (I will eat)</li>
    </ul>
    ...
    <ul class="examples">
      ...
      <li><span class="example-hindi">मैं खाना खा रहा हूँ</span> - I am eating food. (Present Continuous)</li>
  ...
  <div class="panel">
    <p><b>Definition:</b> In passive voice, the object of active sentence becomes the subject.</p>
    <p><b>Structure:</b> Subject + to be + past participle + (by + doer)</p>
    <p><b>Example:</b> Active: She writes a letter.<br /> Passive: A letter is written by her.</p>
    <p class="part-title">Examples (Hindi - English):</p>
    <ul class="examples">
  ...
  <div class="panel">
    <p><b>Definition:</b> Direct speech quotes the exact words. Indirect speech reports what someone said.</p>
    <p><b>Direct:</b> She said, "I am happy."</p>
    <p><b>Indirect:</b> She said that she was happy.</p>
    <p><b>Rules:</b> Pronouns, tenses, and time expressions change when converting.</p>
    <p class="part-title">Examples (Hindi - English):</p>
    <ul class="examples">
...
<div class="container">
  ...
  <!-- Existing accordion content here (omitted here for brevity - you will use the previous code content inside this container) -->
  
  <!-- For demo, let's add only one accordion here to show -->
  ...
  <!-- Add your other accordions from previous answer here similarly -->

  <!-- Quiz Section -->
  <section id="quiz-section">
    <h2>Quick English Grammar Quiz</h2>
    <form id="quiz-form">

      <div class="question" id="q1">
        <p>1. What is a noun?</p>
        <div class="options">
          <label><input type="radio" name="q1" value="a" /> A word that describes an action</label>
          <label><input type="radio" name="q1" value="b" /> A word that names a person, place, or thing</label>
          <label><input type="radio" name="q1" value="c" /> A word that connects sentences</label>
        </div>
      </div>

      <div class="question" id="q2">
        <p>2. Choose the correct pronoun for "मैं":</p>
        <div class="options">
          <label><input type="radio" name="q2" value="a" /> He</label>
          <label><input type="radio" name="q2" value="b" /> I</label>
          <label><input type="radio" name="q2" value="c" /> You</label>
        </div>
      </div>

      <div class="question" id="q3">
        <p>3. Which article should be used before "apple"?</p>
        <div class="options">
      ...
      <div class="question" id="q4">
        <p>4. What type of word is "and"?</p>
        <div class="options">
          <label><input type="radio" name="q4" value="a" /> Preposition</label>
          <label><input type="radio" name="q4" value="b" /> Conjunction</label>
          <label><input type="radio" name="q4" value="c" /> Adjective</label>
        </div>
      </div>

      <div class="question" id="q5">
        <p>5. Passive voice of: "She writes a letter."</p>
        <div class="options">
          <label><input type="radio" name="q5" value="a" /> A letter is written by her.</label>
          <label><input type="radio" name="q5" value="b" /> She is writing a letter.</label>
          <label><input type="radio" name="q5" value="c" /> She wrote a letter.</label>
        </div>
      </div>

      <button id="submit-quiz" type="submit">Submit Answers</button>
    </form>
